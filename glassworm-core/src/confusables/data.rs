...
fn get_confusables_db() -> &'static HashMap<char, ConfusableEntry> {
    ...
    CONFUSABLES_DB.get_or_init(|| {
        ...
        map.insert('\u{0430}', ConfusableEntry {
            confusable: '\u{0430}',
            base: 'a',
            script: "Cyrillic",
            similarity: 1.0,
        ...
        map.insert('\u{0435}', ConfusableEntry {
            confusable: '\u{0435}',
            base: 'e',
            script: "Cyrillic",
            similarity: 1.0,
        ...
        map.insert('\u{043E}', ConfusableEntry {
            confusable: '\u{043E}',
            base: 'o',
            script: "Cyrillic",
            similarity: 1.0,
        ...
        map.insert('\u{0440}', ConfusableEntry {
            confusable: '\u{0440}',
            base: 'p',
            script: "Cyrillic",
            similarity: 1.0,
        ...
        map.insert('\u{0441}', ConfusableEntry {
            confusable: '\u{0441}',
            base: 'c',
            script: "Cyrillic",
            similarity: 1.0,
        ...
        map.insert('\u{0445}', ConfusableEntry {
            confusable: '\u{0445}',
            base: 'x',
            script: "Cyrillic",
            similarity: 1.0,
        ...
        map.insert('\u{0443}', ConfusableEntry {
            confusable: '\u{0443}',
            base: 'y',
            script: "Cyrillic",
            similarity: 1.0,
        ...
        map.insert('\u{0410}', ConfusableEntry {
            confusable: '\u{0410}',
            base: 'A',
            script: "Cyrillic",
            similarity: 1.0,
        ...
        map.insert('\u{0415}', ConfusableEntry {
            confusable: '\u{0415}',
            base: 'E',
            script: "Cyrillic",
            similarity: 1.0,
        ...
        map.insert('\u{041E}', ConfusableEntry {
            confusable: '\u{041E}',
            base: 'O',
            script: "Cyrillic",
            similarity: 1.0,
        ...
        map.insert('\u{0420}', ConfusableEntry {
            confusable: '\u{0420}',
            base: 'P',
            script: "Cyrillic",
            similarity: 1.0,
        ...
        map.insert('\u{0421}', ConfusableEntry {
            confusable: '\u{0421}',
            base: 'C',
            script: "Cyrillic",
            similarity: 1.0,
        ...
        map.insert('\u{0425}', ConfusableEntry {
            confusable: '\u{0425}',
            base: 'X',
            script: "Cyrillic",
            similarity: 1.0,
        ...
        map.insert('\u{0423}', ConfusableEntry {
            confusable: '\u{0423}',
            base: 'Y',
            script: "Cyrillic",
            similarity: 1.0,
        ...
        map.insert('\u{03B1}', ConfusableEntry {
            confusable: '\u{03B1}',
            base: 'a',
            script: "Greek",
            similarity: 0.95,
        ...
        map.insert('\u{03BF}', ConfusableEntry {
            confusable: '\u{03BF}',
            base: 'o',
            script: "Greek",
            similarity: 1.0,
        ...
        map.insert('\u{03B9}', ConfusableEntry {
            confusable: '\u{03B9}',
            base: 'i',
            script: "Greek",
            similarity: 0.9,
        ...
        map.insert('\u{0391}', ConfusableEntry {
            confusable: '\u{0391}',
            base: 'A',
            script: "Greek",
            similarity: 1.0,
        ...
        map.insert('\u{0392}', ConfusableEntry {
            confusable: '\u{0392}',
            base: 'B',
            script: "Greek",
            similarity: 1.0,
        ...
        map.insert('\u{0395}', ConfusableEntry {
            confusable: '\u{0395}',
            base: 'E',
            script: "Greek",
            similarity: 1.0,
        ...
        map.insert('\u{0396}', ConfusableEntry {
            confusable: '\u{0396}',
            base: 'Z',
            script: "Greek",
            similarity: 1.0,
        ...
        map.insert('\u{0397}', ConfusableEntry {
            confusable: '\u{0397}',
            base: 'H',
            script: "Greek",
            similarity: 1.0,
        ...
        map.insert('\u{0399}', ConfusableEntry {
            confusable: '\u{0399}',
            base: 'I',
            script: "Greek",
            similarity: 1.0,
        ...
        map.insert('\u{039A}', ConfusableEntry {
            confusable: '\u{039A}',
            base: 'K',
            script: "Greek",
            similarity: 1.0,
        ...
        map.insert('\u{039C}', ConfusableEntry {
            confusable: '\u{039C}',
            base: 'M',
            script: "Greek",
            similarity: 1.0,
        ...
        map.insert('\u{039D}', ConfusableEntry {
            confusable: '\u{039D}',
            base: 'N',
            script: "Greek",
            similarity: 1.0,
        ...
        map.insert('\u{039F}', ConfusableEntry {
            confusable: '\u{039F}',
            base: 'O',
            script: "Greek",
            similarity: 1.0,
        ...
        map.insert('\u{03A1}', ConfusableEntry {
            confusable: '\u{03A1}',
            base: 'P',
            script: "Greek",
            similarity: 1.0,
        ...
        map.insert('\u{03A4}', ConfusableEntry {
            confusable: '\u{03A4}',
            base: 'T',
            script: "Greek",
            similarity: 1.0,
        ...
        map.insert('\u{03A7}', ConfusableEntry {
            confusable: '\u{03A7}',
            base: 'X',
            script: "Greek",
            similarity: 1.0,
        ...
        map.insert('\u{03A5}', ConfusableEntry {
            confusable: '\u{03A5}',
            base: 'Y',
            script: "Greek",
            similarity: 0.95,
