...
//! used in GlassWorm-style attacks.
//!
//! ## Encoding Scheme
//!
//! The GlassWorm campaign uses a substitution cipher mapping 256 invisible
...
///
/// ```rust
/// use glassworm_core::decoder::decode_vs_stego;
///
...
pub fn decode_vs_stego(input: &str) -> Option<DecodedPayload> {
    ...
    for ch in input.chars() {
        let cp = ch as u32;
        let byte = if cp >= 0xFE00 && cp <= 0xFE0F {
...
///
/// ```rust
/// use glassworm_core::decoder::shannon_entropy;
///
