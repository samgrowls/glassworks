...
use crate::confusables::data::{get_base_char, get_confusable_script, get_similarity, is_confusable};
use crate::finding::{Severity, UnicodeCategory, UnicodeFinding};
use crate::script_detector::{extract_identifiers, find_identifier_at_position, has_mixed_scripts, is_pure_non_latin};
