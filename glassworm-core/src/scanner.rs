...
use crate::detectors::{BidiDetector, GlasswormDetector, HomoglyphDetector, InvisibleCharDetector, UnicodeTagDetector};
...
/// }
/// ```
pub fn scan(content: &str, filename: &str) -> Vec<UnicodeFinding> {
