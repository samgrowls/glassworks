# Binary Consolidation - Executive Summary
...
Consolidate two Rust binaries (`glassware-cli` and `glassware-orchestrator`) into a single unified `glassware` binary while achieving:
